...
for i in "${list[@]}" ; do 
    cd /projects/b1042/HartmannLab/Howler/humann/${i}
    cp ${i}_genefamilies.tsv  ${i}_pathabundance.tsv ${i}_pathcoverage.tsv  /projects/b1042/HartmannLab/Howler/humann/all
done
